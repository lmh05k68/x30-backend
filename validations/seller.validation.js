...
export const sellerValidateRegisterRequest = async (req, res, next) => {
...
export const sellerValidateLoginRequest = async (req, res, next) => {
    const schema = Joi.object({
      email: Joi.string()
        .email()
        .required()
  ...
  export const validateUpdateSellerRequest = async (req, res, next) => {
    const schema = Joi.object({
      fullName: Joi.string()
        .required()
        .max(255)

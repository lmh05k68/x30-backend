...
import { createNewProductGroup, sellerGetProductGroups, sellerGetProductGroupById, sellerAddProduct, buyerGetProductGroups, buyerGetProductGroupById } from "../controllers/productGroups.controllers.js";
...
ProductGroupsRouter.post("/seller/create-productgroup", upload.single("file"), sellerAuthMiddleware.authentication, createNewProductGroup);
ProductGroupsRouter.get("/seller/productgroup", sellerAuthMiddleware.authentication, sellerGetProductGroupById);
ProductGroupsRouter.patch("/seller/add-product", sellerAuthMiddleware.authentication, sellerAddProduct)
